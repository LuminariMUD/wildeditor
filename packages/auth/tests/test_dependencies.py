...
from wildeditor_auth.dependencies import (
    # verify_api_key,  # noqa: F401 - imported for future use
    # verify_mcp_key,  # noqa: F401 - imported for future use
    # verify_backend_access_key,  # noqa: F401 - imported for future use
    get_auth_dependency,
    RequireBackendKey,
    RequireMCPKey,
...
def create_test_app():
    ...
    async def test_backend_access_endpoint(
            authenticated: bool = RequireBackendAccessKey):
        return {
            "message": "Backend access granted",
            "authenticated": authenticated}
...
class TestDependencies:
    ...
    def test_backend_auth_failure_invalid_key(
            self, client, mock_env, invalid_key):
    ...
    def test_mcp_auth_failure_wrong_key(
    ...
    def test_backend_access_auth_success(
            self, client, mock_env, valid_mcp_backend_key):
