...
- **Format**: `mysql+pymysql://username:<redacted>@hostname:port/database_name`
- **Example**: `mysql+pymysql://wildeditor_user:<redacted>@db.example.com:3306/luminari_mudprod`
...
Copy the generated key (e.g., `<redacted>`)
...
- **Value**: `mysql+pymysql://your_username:<redacted>@your_host:3306/your_database`

#### API Key Secret ⭐ NEW
- **Name**: `WILDEDITOR_API_KEY`
- **Value**: `<redacted>` (your generated key)
...
MYSQL_DATABASE_URL=mysql+pymysql://wildeditor_user:<redacted>@db.luminari.com:3306/luminari_mudprod
WILDEDITOR_API_KEY=<redacted>
PRODUCTION_HOST=server.luminari.com
PRODUCTION_USER=wildedit
PRODUCTION_SSH_KEY=<redacted>
