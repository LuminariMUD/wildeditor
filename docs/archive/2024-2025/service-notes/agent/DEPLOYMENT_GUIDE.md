...
|------------|-------------|---------------|-------|
| `WILDEDITOR_MCP_KEY` | API key for MCP server | `<redacted>` | Already set for MCP deployment |
| `WILDEDITOR_API_KEY` | API key for backend | `<redacted>` | Already set for backend deployment |
