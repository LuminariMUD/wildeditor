...
2. **Edit `.env.development` with your actual values:**
   ...
   MYSQL_DATABASE_URL=mysql+pymysql://wildeditor_dev_user:<redacted>@localhost:3306/luminari_muddev
...
export MYSQL_DATABASE_URL="mysql+pymysql://wildeditor_dev_user:<redacted>@localhost:3306/luminari_muddev"
